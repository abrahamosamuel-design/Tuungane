          ...
          {pages.map((page) => (
            <div key={page.id} className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border p-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Link to="/requests/new" className="inline-flex items-center gap-1 rounded-full border border-border px-3 py-1.5 text-xs font-semibold text-navy hover:border-orange"><Briefcase className="h-3.5 w-3.5" /> Create a Request</Link>
